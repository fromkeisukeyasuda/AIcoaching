    ...
    <main className="h-screen flex flex-col bg-slate-50">
      ...
      <div className="flex-shrink-0 bg-white border-t border-slate-100">
        <div className="max-w-3xl mx-auto px-4 py-3">
          ...
          {/* ステータス表示 */}
          <div className="flex items-center justify-between mt-1.5 px-1 min-h-[18px]">
            {voice.errorMsg ? (
            ...
            {tts.enabled && (
              <p className="text-xs text-indigo-400 flex items-center gap-1 flex-shrink-0 ml-2">
